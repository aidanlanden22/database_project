...
<!-- ****************** CREATE NEW ACCOUNT ****************** -->
            ...
            <div id="NewAccount" class="tabcontent">  <!--NewAccount form-->
                ...
                <div class="form-group">
                    <input type="email" class="form-control" id="NewAccountEmail" name="email" placeholder="Please input your email address" autofocus required autocomplete required/>
