...
while($row = mysqli_fetch_array($result)) {
  $Rings .= '<li>';
  $Rings .= '<img src="#" />';
  $Rings .= '<h4>' . $row['name'] . '</h4>';
  $Rings .= '<p>' . $row['description'];
  $Rings .= " " . $row['brand'];
  $Rings .= " " . $row['color'] . '</p>';

  $Rings .= '<p>' . "$" . $row['price'];
  $Rings .= " " . "stock:" . $row['stock'];
  
  $Rings .= " " . "rating:" . $row['rating'];
  $Rings .= " " . $row['condition'] . '</p>';
  
  $Rings .= '<p>' . $row['release_date_year'];
  $Rings .= " " . $row['release_date_season'] . '</p>';
  $Rings .= '</li>';
}
mysqli_close($con);
$Rings .= '</ul>';
